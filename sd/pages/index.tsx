  ...
  return (
    <div className="page">
      ...
      <div id="tabs" className="tab">
        ...
        <footer><p><span className="icon-container"><a href="https://github.com/tiptenbrink/statusdeploy" className="icon">
                ...
                </svg>&nbsp;Code</a></span> — Built with <a href="https://alephjs.org/">Aleph.js</a></p>
        </footer>
    </div>
  )
}
